<template>
  <div>
    <!-- ========== HEADER ========== -->
    <header
      class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-[#060826] border-b border-gray-200 text-sm py-4 dark:bg-neutral-800 dark:border-neutral-700"
    >
      <nav
      ...
      >
        <div class="flex items-center justify-between">
          <a
            class="flex-none text-xl text-[#07d884] font-semibold dark:text-white"
            href="#"
            aria-label="Brand"
            >P.R.E</a
          >
        ...
        >
          ...
          >
            <a class="font-medium text-[#07d884]" href="#" aria-current="page"
              >Home</a
            >
            <a

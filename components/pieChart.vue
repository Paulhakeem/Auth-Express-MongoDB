    ...
    <div class="flex items-center flex-wrap max-w-md px-10 bg-white shadow-xl rounded-2xl h-20"
       >
          <div class="flex items-center justify-center -m-6 overflow-hidden bg-white rounded-full">
            ...
            <span class="absolute text-2xl text-[#07d884]" x-text="`${percent}%`"> 89% </span>
          </div>
          <p class="ml-10 font-medium text-gray-600 sm:text-xl">Performance</p>

          <span class="ml-auto text-xl font-medium text-[#07d884] hidden sm:block">+25%</span>
      </div>
    ...
    <div class="flex items-center flex-wrap max-w-md px-10 bg-white shadow-xl rounded-2xl h-20"
       ...
       >
          <div class="flex items-center justify-center -m-6 overflow-hidden bg-white rounded-full">
            ...
            <span class="absolute text-2xl text-red-700" x-text="${percent}%">60%</span>
          </div>
          <p class="ml-10 font-medium text-gray-600 sm:text-xl">Messages</p>

          <span class="ml-auto text-xl font-medium text-red-600 hidden sm:block">+10%</span>
      </div>
  </div>
</div>
